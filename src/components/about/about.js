            ...
            <div className="d-flex flex-column min-vh-100 justify-content-center align-items-center">
                <div className="row m-4">
                    <div className="col-lg-6 mt-5">
                        <img src={profilePictureImg} className="img-fluid mx-auto d-block img-thumbnail"
                             alt={"Armin Bruckmann"}/>
                    </div>
                    <div className="col-lg-6 mt-5">
                        <h2>About Me</h2>
                        ...
                        <p>Currently, I am studying Computer Science at the technical college Georg Simon Ohm,
                            Nuremberg Germany. I expect to finish my Bachelor's degree in the summer semester of
                            2022. </p>
